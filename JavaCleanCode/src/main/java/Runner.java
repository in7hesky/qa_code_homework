...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport militaryAirport = new Airport(airport.getPlanesIfInstanceOf(MilitaryPlane.class));
        Airport passengerAirport = new Airport(airport.getPlanesIfInstanceOf(PassengerPlane.class));
